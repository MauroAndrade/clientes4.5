...
//     Configuration file:     "CrMall\Web.config"
//     Connection String Name: "Connection"
//     Connection String:      "Data Source=DESKTOP-DI2ILJP\SQLEXPRESS;Initial Catalog=crmall;User ID=sa;password=**zapped**;;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"
// ------------------------------------------------------------------------------------------------
...
namespace CrMall.Models
{
    ...
    public class ClienteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Cliente>
    {
        ...
        public ClienteConfiguration(string schema)
        {
            ...
            Property(x => x.Nascimento).HasColumnName(@"nascimento").HasColumnType("datetime").IsRequired();
            Property(x => x.Sexo).HasColumnName(@"sexo").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(10);
            ...
            Property(x => x.Complemento).HasColumnName(@"complemento").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(100);
            Property(x => x.Bairro).HasColumnName(@"bairro").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(150);
            Property(x => x.Estado).HasColumnName(@"estado").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(150);
            Property(x => x.Cidade).HasColumnName(@"cidade").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(150);
        }
    }
